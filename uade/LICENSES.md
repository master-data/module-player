...
The licensing and redistribution assessment for this repository is complete. Keep all embedded copyright/licence headers intact, retain this notice file, and preserve the contributor acknowledgement in `../ACKNOWLEDGMENTS.md` in downstream redistributions.
